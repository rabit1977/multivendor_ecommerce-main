              ...
              >
                ...
                <div className='h-9 w-[227px]'>
                  <div className='inline-flex relative w-full'>
                    ...
                    <input
                      ...
                      disabled
                      value={sort}
                      className='pl-[70px] text-sm font-bold h-9 pr-10 bg-none border cursor-pointer px-3 bg-transparent text-main-primary dark:text-main-secondary w-full outline-0 align-bottom'
                    />
                    <div className='relative'>
                      <span
                ...
                >
                  {sortArray.map((option) => (
                    <li
                      key={option.query}
                      className='w-full flex items-center justify-between bg-white dark:bg-slate-800 hover:bg-gray-100 cursor-pointer h-8 px-4 text-xs'
