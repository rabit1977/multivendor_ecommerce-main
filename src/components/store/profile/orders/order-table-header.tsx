...
const OrderTableHeader: FC<Props> = ({
  ...
  return (
    <div className='pt-4 px-6 bg-white dark:bg-slate-800 dark:text-white border-b'>
      <div className='flex items-center justify-between'>
        <div className='-ml-3 text-main-primary dark:text-white text-sm'>
          <div className='relative overflow-x-hidden'>
            <div className='py-4 inline-flex items-center bg-white dark:bg-slate-800 dark:text-ellipsis justify-center relative'>
              {filters.map((f, i) => (
                <div
                  key={f.filter}
                  className={cn(
                    'relative px-4 text-main-primary dark:text-white whitespace-nowrap cursor-pointer leading-6',
                    {
